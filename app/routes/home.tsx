...
// 新上架商品
const arrivals = [
  { id: 1, name: "動漫手辦", desc: "高精度細節刻畫", price: "$34.99", swatch: "bg-purple-400" },
  { id: 2, name: "周邊掛件", desc: "便攜式鑰匙鍊", price: "$12.99", swatch: "bg-indigo-400" },
  { id: 3, name: "角色抱枕", desc: "舒適絨面材質", price: "$49.99", swatch: "bg-violet-400" },
];
...
function ArrivalCard({ product }: { product: typeof arrivals[0] }) {
  return (
    <article 
      className="group rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-lg focus-within:ring-2 focus-within:ring-rose-500 focus-within:ring-offset-2"
    >
      <Link
        to="/product"
      ...
      >
        ...
        <div className="space-y-1 text-sm">
          ...
          <p className="font-bold text-rose-600 pt-1">{product.price}</p>
        </div>
      </Link>
    </article>
  );
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col">
      ...
      <div className="flex-1">
        ...
        {/* 新上架商品 */}
        <section className="bg-white px-10 pb-10 pt-8">
          <div className="mx-auto max-w-5xl">
            <h2 className="text-2xl font-bold text-slate-900">最新周邊</h2>
            <p className="text-slate-600 text-sm mt-2">最熱門的 IP 周邊商品</p>
